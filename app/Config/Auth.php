...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'login'                       => 'App\Views\Systems\Auth\login',
        'register'                    => 'App\Views\Systems\Auth\register',
        'layout'                      => '\App\Views\Systems\Auth\layout',
     ...
     */
    public string $userProvider = 'App\Models\Systems\UsersModel'; //UserModel::class;
