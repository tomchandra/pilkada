...
<form class="form w-100" action="<?= base_url("systems/menus/save") ?>" method="post">
   <?= csrf_field() ?>
   <div class="card card-bordered">
      <div class="card-body">
         <div class="mb-5">
            ...
            <input class="form-control form-control-sm form-control-solid" name="name" value="<?= old('name') ?>">
         </div>
         <div class="mb-5">
            <div class="row">
               <div class="col-lg-6">
                  ...
                  <input class="form-control form-control-sm form-control-solid" name="modules" value="<?= old('modules') ?>">
               ...
               <div class="col-lg-6">
                  ...
                  <input class="form-control form-control-sm form-control-solid" name="routes" value="<?= old('routes') ?>">
               </div>
            </div>
         </div>
         <div class="mb-5">
            ...
            <select name="icons" id="icons" class="form-select form-select-sm form-select-solid" data-control="select2" data-placeholder="Select an option">
               ...
               <?php if (count(bootstrap_icons()) > 0) : ?>
                  <?php foreach (bootstrap_icons() as $key => $value) : ?>
                     <option value="bi-<?= $value; ?>" data-select2-icons="bi bi-<?= $value ?>" <?= (old('icons') == "bi-" . $value ? "selected" : "") ?>><?= $value ?></option>
                  <?php endforeach; ?>
               <?php endif; ?>
            </select>
         </div>
         <div class="mb-5">
            ...
            <div class="form-check form-switch">
               <input class="form-check-input" type="checkbox" role="switch" id="statusCd" checked='checked' value="active" name="status_cd">
