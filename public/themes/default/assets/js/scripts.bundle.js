...
var KTToggle = function(element, options) {
    ...
    const _largeDevice = window.matchMedia("(min-width: 992px)");
    ...
    var _initAsideMediaQueries = () => {
        _largeDevice.addEventListener('change', (e) => {
            _handleAsideChange(e.target);
        });
        _handleAsideChange(_largeDevice);
    }
    ...
    var _handleAsideChange = (e) => {
        let el_bgColor, el_width, el_display;
        let status = document.querySelector('[data-kt-aside-minimize="on"]');
        let state  = !status ? 'open' : 'close';
        const headerBrand = document.getElementById('color-header-brand');
        const headerLogo  = document.querySelector('#color-header-brand > a');
        ...
        headerBrand.style.backgroundColor = el_bgColor;
        headerBrand.style.width  = el_width;
        headerLogo.style.display = el_display;
    }
